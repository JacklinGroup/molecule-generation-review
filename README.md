...
- [2020]**ARAE: Adversarially Regularized Autoencoders**

  Zhao J, Song Y, Ermon S

  Input: 1D Seq.

  [paper](https://arxiv.org/abs/1705.10942) | [code](None)
...
- [2020]**D-MolVAE: a variational autoencoder for molecular generation**
  ...
  [paper](https://doi.org/10.1007/978-3-030-50423-5_6) | [code](None)
...
- [2021]**Graph Transformer VAE: Graph Transformer VAE for molecular graph generation**
  ...
  Madhawa K, Ishiguro K, Nakamura K, Akiyama Y

  Input: 2D Graph

  [paper](https://doi.org/10.1093/bib/bbab418) | [code](None)
...
- [2021]**GraphCNF: Conditional Flow Models for Graph Generation**
  ...
  Liu R, Maddison L J, Hashimoto T, Uesaka T, Dyer C, Poole B
...
- [2025]**GGFlow: graph-guided flow matching for 2D and 3D molecular generation**
...
- [2026]**Megalodon-flow: large-scale flow matching for 3D molecular generation**
...
- [2025]**MDRL: molecular diffusion with reinforcement learning**
  ...
  [paper](None) | [code](https://github.com/Xino11024/MDRL)
