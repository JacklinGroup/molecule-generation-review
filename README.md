...
- [2018]**Pretrained JT-VAE for HOMO value prediction and molecular optimization**
...
- [2020]**Re-balancing VAE: Re-balancing variational autoencoder loss for molecule sequence generation**
...
- [2021]**Attention-based VAE: Attention-based generative models for de novo molecular design**
...
- [2021]**Conditional β-VAE: Conditional beta-VAE reproducibility: challenges and extensions**
...
- [2024]**Transformer VAE: Transformer VAE for unseen structure generation**
...
- [2025]**Adaptive β-VAE: Adaptive beta-VAE for optimized organic fluorophore search**
